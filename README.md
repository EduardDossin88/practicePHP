# Target Audience Data Analyzer (PHP MVC)

Учебный проект: создание собственного MVC-фреймворка на чистом PHP и разработка приложения для анализа данных о целевой аудитории компании.

Приложение разделено на слои (MVC), нет смешивания HTML/PHP/SQL в одном файле, есть соблюдение стандартов **PSR-1** и **PSR-12**.

## Цели проекта:
1. Погружение в устройство PHP.
2. Написание собственного фреймворка (Router, Front Controller, ORM-like Models).
3. Написание переиспользуемого и поддерживаемого кода.
...
Для выполнения задач внутри контейнеров используем 'Make':
...
## Чтобы активировать pre-commit хуки локально, выполните команду: 
